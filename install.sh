...
echo ""
echo "2. Pull a Jira issue:"
echo -e "   ${GREEN}docker run -it --rm -v ~/.config/acli:/root/.config/acli davidsmith3/acli jira workitem view PROJ-123${NC}"
echo ""
echo "Documentation:"
...
echo ""
echo "Run Directly:"
echo "   docker run --rm -v ~/.config/acli:/root/.config/acli -v \$(pwd):/workspace -w /workspace davidsmith3/acli jira workitem view [ISSUE_KEY]"
echo ""
echo "Alias:"
